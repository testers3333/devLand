...
-- local is a function that is always put before a variable so that it is not global
...
-- print is used to run anything in your terminal when launching the games
