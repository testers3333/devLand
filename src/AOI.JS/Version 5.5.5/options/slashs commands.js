...
// the code to be evaluated for the code at the top : $createApplicationCommand[$guildID;name of slash;description of slash;true]
module.exports ={
    name:"name of slash",
    type:"interaction",
    prototype:"slash",
...
/* the code to be evaluated for the code at the top : $createApplicationCommand[$guildID;name of slash;description of slash;true;slash;{
 ...
 For more options go to the files "embeds options"
*/
